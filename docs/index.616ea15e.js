...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$init = function(starting_score) {
        return _Utils_Tuple2({
            hitsPerSecond: 0,
            message: "Press 'Up' to score a run!",
    ...
    var $author$project$Main$Nothing = {
        $: "Nothing"
    };
    var $author$project$Main$NumberUp = {
        $: "NumberUp"
    };
    var $author$project$Main$toKey = function(string) {
        if (string === "ArrowUp") return $author$project$Main$NumberUp;
        else return $author$project$Main$Nothing;
    };
    var $author$project$Main$decoder = A2($elm$json$Json$Decode$map, $author$project$Main$toKey, A2($elm$json$Json$Decode$field, "key", $elm$json$Json$Decode$string));
    ...
    var $author$project$Main$subscriptions = function(_v0) {
        return $elm$core$Platform$Sub$batch(_List_fromArray([
            $elm$browser$Browser$Events$onKeyDown($author$project$Main$decoder),
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        switch(msg.$){
            ...
            case "Tick":
                return model.score < 100000 ? _Utils_Tuple2(_Utils_update(model, {
            ...
            default:
                ...
                var hits = msg.b;
                return _Utils_Tuple2(_Utils_update(model, {
                    hitsPerSecond: model.hitsPerSecond + hits,
    ...
    var $author$project$Main$NewHitter = F2(function(a, b) {
        return {
            $: "NewHitter",
            a: a,
            b: b
    ...
    var $author$project$Main$player = F4(function(name, cost, hits, score) {
        return A2($elm$html$Html$button, _List_fromArray([
            $elm$html$Html$Events$onClick(A2($author$project$Main$NewHitter, cost, hits)),
            $elm$html$Html$Attributes$disabled(_Utils_cmp(score, cost) < 0)
        ]), _List_fromArray([
    ...
    _Platform_export({
        "Main": {
            "init": $author$project$Main$main($elm$json$Json$Decode$int)(0)
        }
    });
})(this);
